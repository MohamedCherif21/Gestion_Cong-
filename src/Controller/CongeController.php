...
class CongeController extends AbstractController
{
   ...
   /* #[Route('/new/{id}', name: 'app_conge_new', methods: ['GET', 'POST'])]
    public function news($id,Request $request, CongeRepository $congeRepository,SoldeCongeRepository $soldeCongeRepository): Response
    {
        $conge = new Conge();
        ...
        return $this->renderForm('conge/new.html.twig', [
            'conge' => $conge,
            'form' => $form,
            'solde_conges' => $soldeCongeRepository->find($id),
        ]);
        
    }*/

    #[Route('/new', name: 'app_conge_new', methods: ['GET', 'POST'])]
    public function new(Request $request, CongeRepository $congeRepository,SoldeCongeRepository $soldeCongeRepository): Response
    {
        $conge = new Conge();
        $form = $this->createForm(CongeType::class, $conge);
        $form->handleRequest($request);
