 ...
 */
final class Version20221114231729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conge ADD CONSTRAINT FK_2ED89348BC7F70A9 FOREIGN KEY (solde_id) REFERENCES solde_conge (id)');
